...
{% block content %}
    ...
    <a href="{% raw %}{% url 'articles' %}{% endraw %}">목록 보기</a>
...
{% block content %}
    ...
    <form action="{% raw %}{% url 'update' article.pk %}{% endraw %}" method="POST">
        {% csrf_token %}
...
{% block content %}
    ...
    <form action="{% raw %}{% url 'delete' article.pk %}{% endraw %}" method="POST">
        {% csrf_token %}
